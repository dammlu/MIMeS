...
#rarefy dataset to 50.000 reads

rarefaction_level <- 50000
...
for (i in seq_along(division_factors)) {
  ...
  filename <- paste0("rarefaction_50K_result_", i, ".csv")
...
write.csv(rarefied_bulk_t, "bulk_bootstrap_50K.csv", row.names = TRUE)
